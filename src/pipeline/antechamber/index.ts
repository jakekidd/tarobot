// Public surface of the antechamber engine module. Everything the UI / scripts /
// other pipeline code needs comes through here.

export { AntechamberEngine, STARTER_SEED_COUNT } from './engine';
...
export { parseGuessAnswer, encodeGuessAnswer } from './instruments';
export type { Instrument, GuessInstrument, GuessResult } from './instruments';
...
export type { QueuedGuess } from './types';
