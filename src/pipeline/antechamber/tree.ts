...
//
// The survey is authored in `pillars.md` (sibling file). Edits there ship
...
import surveyMdSource from '../../../materials/pillars.md?raw';
import { parsePillarsMd } from './parsePillarsMd';
import type {
  AnswerFormat,
  DialogueTree,
  RenderedQuestion,
...
const BUNDLED_TREE: DialogueTree = parsePillarsMd(surveyMdSource);

// The active tree. Sourced from pillars.md (validated at module load —
 ...
 *  whatever materials/pillars.md authors under `## Pillars`. */
