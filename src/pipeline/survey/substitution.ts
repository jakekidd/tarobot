...
export function hasAllRequiredFields(text: string, profile: SurveyProfile): boolean {
 ...
 */
export function substituteOrBlank(text: string, profile: SurveyProfile): string {
 ...
 */
export function substituteOrNull(text: string, profile: SurveyProfile): string | null {
...
function hasField(profile: SurveyProfile, field: string): boolean {
  switch (field) {
...
function formatField(profile: SurveyProfile, field: string): string {
  switch (field) {
