...
type Props = {
  /** Square size in CSS pixels — defines how big Clat renders here. */
  size?: number;
};

/**
 * Invisible placeholder div. Reports its bounding box to the anchor
 * store. The full-screen Three.js scene reads this and renders Clat
 * at this position, at this size. Lets us position Clat as if he were
